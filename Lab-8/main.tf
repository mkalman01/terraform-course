...
output "my_vm1_ip" {
  value = [aws_instance.my_web_app.public_ip, aws_instance.my_web_db.public_ip, aws_instance.my_web_server.public_ip]
}
output "my_vm_ip_private" {
  value = [aws_instance.my_web_app.private_ip, aws_instance.my_web_db.private_ip, aws_instance.my_web_server.private_ip]
}
